...
class Ec2TerminateInstancesJobTest {
    ...
    public void testDesign() throws ArooaParseException {
        ...
        String xml =
                "<aws:ec2-terminate-instances instanceIds=\"12, 34\" name=\"Our Test\" xmlns:aws=\"oddjob:aws\"/>";
    ...
    public static void main(String args[]) throws ArooaParseException {
        ...
        Ec2TerminateInstancesJobTest test = new Ec2TerminateInstancesJobTest();
        test.testDesign();
