...
class Ec2StartInstancesJobTest {
    ...
    public void testDesign() throws ArooaParseException {
        ...
        String xml =
                "<aws:ec2-start-instances instanceIds=\"12, 34\" name=\"Our Test\" xmlns:aws=\"oddjob:aws\"/>";
    ...
    public static void main(String args[]) throws ArooaParseException {
        ...
        Ec2StartInstancesJobTest test = new Ec2StartInstancesJobTest();
        test.testDesign();
